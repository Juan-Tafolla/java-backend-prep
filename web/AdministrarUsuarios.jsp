                                ...
                                <table class="table table-striped dataTable table-hover" border ='5' class="display">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <% out.print(usuarios.get(i).getApellidos()); %>
                                            </td>
                                            <td class="text-center">
                                                <% out.print(usuarios.get(i).getUsuario()); %>
                                            </td>
                                            <td class="text-center">
                                                <%
                                                    if (usuarios.get(i).getIdCargo().equals("1")) {
                                            ...
                                            <td class="text-center">
                                                <a href = "Controlador?accion=ActualizarUsuarios&idUsuario=<% out.print(usuarios.get(i).getId()); %>" class="btn btn-primary" role="button"> Actualizar </a>
                                                <input type="hidden" id="codigo" value="<% out.print(usuarios.get(i).getId()); %>">
                                                <a id="deleteUser" href="<c:url value="Controlador">
                                                       <c:param name="accion" value="BorrarUsuario" />
                                                       <c:param name="idUsuario" value="${ usuarios.get(i).getId() }" />
