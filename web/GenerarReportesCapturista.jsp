        ...
        <div class="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"> ${ Moderador.usuario } </span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>                    
                                            Bienvenido - ${ Moderador.usuario }
                                            <small>Usted es un, ${ Moderador.cargo.nombreCargo } </small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p> Bienvenido, ${ Moderador.usuario } </p>
                            <!-- Status -->
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li> <a href="FormularioCapturista.jsp"> <i class="fa fa-dashboard"> </i> Inicio </a> </li>
...
<%    } else {
        response.sendRedirect("FormularioAdministrador.jsp");
    }
%>