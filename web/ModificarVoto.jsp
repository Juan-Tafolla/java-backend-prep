                    ...
                    <div class = "social-auth-links text-center">
                        ...
                        <form action="Controlador" method="post">
                            ...
                            <div class="form-group has-feedback">
                                <input type="text" name="txtIdRegistro" id="txtIdRegistro" value="${Registro_Actualizar.idRegistro}" placeholder="Registro" class="form-control" readonly required>
                                <span class="glyphicon glyphicon-user form-control-feedback"> </span>
                            </div>
                            <div class = "social-auth-links text-left">
                                <label> Partido Político </label>
                                <div class="form-group has-feedback">
                                    <select name="txtPartido" class="form-control" label="txtPartido" required>
                                        <option value="${Registro_Actualizar.partido}"> Actual: ${Registro_Actualizar.partido} </option>
                            ...
                            <div class = "social-auth-links text-left">
                                ...
                                <div class="form-group has-feedback">
                                    <select name="txtCandidatura" class="form-control" label="txtCandidatura" required>
                                        <option value="${Registro_Actualizar.candidatura}"> Actual: ${Registro_Actualizar.candidatura} </option>
                            ...
                            <div class = "social-auth-links text-left">
                                <label> Votos: </label>
                                <div class="form-group has-feedback">
                                    <input type="text" name="txtVotos" id="txtVotos" value="${Registro_Actualizar.votos}" placeholder="Votos" class="form-control" required pattern="[0-9]{1,10}">
                            ...
                            <div class = "social-auth-links text-left">
                                ...
                                <div class="form-group has-feedback">
                                    <select name="txtDistrito" class="form-control" label="txtDistrito" required>
                                        <option value="${Registro_Actualizar.distrito}"> Actual: ${Registro_Actualizar.distrito} </option>  
                            ...
                            <div class = "social-auth-links text-left">
                                ...
                                <div class="form-group has-feedback">
                                    <input type="text" name="txtSeccional" id="txtSeccional" value="${Registro_Actualizar.seccional}" placeholder="Seccional" class="form-control" required>
                                    <span class="glyphicon glyphicon-inbox form-control-feedback"> </span>
                                </div>
                            </div>
                            <div class = "social-auth-links text-left">
                                <label> Id de Casilla: </label>
                                <div class="form-group has-feedback">
                                    <select name="txtCasilla" class="form-control" label="txtCasilla" required>
                                        <option value="${Registro_Actualizar.casilla}"> Actual: ${Registro_Actualizar.casilla} </option>
                            ...
                            <div class = "social-auth-links text-left">
                                <label> Tipo de Casilla: </label>
                                <div class="form-group has-feedback">
                                    <select name="txtTipoCasilla" class="form-control" label="txtTipoCasilla" required>
                                        <option value="${Registro_Actualizar.tipoCasilla}"> Actual: ${Registro_Actualizar.tipoCasilla} </option>
